...
const Signup = () => {
  ...
  const onSubmit = (event) => {
    ...
    userSignup({ username, email, password }).then((data) => {
      if (data.error) {
  ...
  const successMsg = () => {
    return (
      <>
        <div
          className="container alert text-center alert-success"
  ...
  const errorMsg = () => {
    return (
      <div
        className="container alert text-center alert-danger"
            ...
            <div className="card col-10 col-md-8 col-lg-6 p-5 m-auto shadow">
              <div className="card-body">
                <form className="form-signup">
                  <h1 className="display-4 mt-3 mb-5 text-dark text-center">
                    Signup
                  </h1>
